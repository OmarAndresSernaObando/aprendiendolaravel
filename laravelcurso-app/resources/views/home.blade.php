    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Soluciones creativas y elegantes</h1>
          <h2>Estamos a la vanguardia en las ultimas tecnologias de desarrollo web</h2>
          <div class="d-flex">
            <a href="#about" class="btn-get-started scrollto">Conocenos</a>
            <a href="https://www.youtube.com/watch?v=GyHVDGgCrDI" class="venobox btn-watch-video" data-vbtype="video" data-autoplay="true"> Mira el video <i class="icofont-play-alt-2"></i></a>
          </div>
        </div>
    ...
    <section id="counts" class="counts">
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up">10,752</span>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Localizacion:</h4>
                <p>Carrera 20 #48C-03, Manizales, Colombia</p>
              </div>

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4>Email:</h4>
                <p>andres.serna.proyectos@gmail.com</p>
              </div>
              ...
              <iframe src="https://maps.google.com/maps?width=100%&height=600&hl=es&coord=5.067238, -75.498354&q=Carrera%2020%20%2348C-03%2C%20Manizales%2C%20Caldas%2C%20Colombia+(Hogar%20Andres%20Serna%20Obando)&ie=UTF8&t=&z=14&iwloc=B&output=embed" frameborder="0" style="border:0; width: 100%; height: 290px;" allowfullscreen></iframe>
            </div>
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
          	<!--
          		Formulario que utilizaremos para trabajar el proceso de mailing desde Laravel. Comentario hecho por Andres Serna Obando.
          	-->
            <form action="{{route('messages')}}" method="post" role="form" class="php-email-form">
            	<!--Super importante esta siguiente linea de codigo, para encriptar la informacion entregada por el formulario-->
            	{{csrf_field()}}
              <div class="form-row">
              	<!--Condicion que me permite evaluar si ya ha sido enviado el mensaje de correo-->
              	...
              	<div class="alert alert-success" role="alert">
					  ...
					  <h4 class="alert-heading">Notificacion!</h4>
					  <p>{{session()->get('flash')}}</p>
					  <hr>
					  <p class="mb-0">Recuerda que esta alerta fue invocada desde Bootstrap, para servicios de plataforma LARAVEL.</p>
				</div>
				@endif
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="body" rows="10" data-rule="required" data-msg="Please write something for us"></textarea>
                <div class="validate"></div>
              </div>
              <div class="mb-3">
